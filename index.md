<html>
<head>
	<style>.embeddedMessagingConversationButtonWrapper, .slds-button { width: 40px !important; height: 40px !important; }
	#embeddedMessagingIconContainer svg, embeddedmessaging-minimized-state svg, button svg, .minimizedButton[lwc-2tu55qmbbaf] div[class="minimizedButtonIconContainer"][lwc-2tu55qmbbaf] > svg.minimizedButtonIconChat[lwc-2tu55qmbbaf], .slds-button svg  { max-height: 20px; max-width: 20px; } </style>
</head>
  <body>
