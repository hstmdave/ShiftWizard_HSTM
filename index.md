...
<head>
	...
	#embeddedMessagingIconContainer svg, button svg, .minimizedButton[lwc-2tu55qmbbaf] div[class="minimizedButtonIconContainer"][lwc-2tu55qmbbaf] > svg.minimizedButtonIconChat[lwc-2tu55qmbbaf], .slds-button svg  { max-height: 20px !important; max-width: 20px !important; } </style>
</head>
  <body>
